...
def sync_processing(input_a: int):
...
if __name__ == '__main__':
    # score1, explanation1 = process_fluent(1)  # should run synchrnously without any call to the lib
    # print(score1, explanation1)
    score2, explanation2 = process_fluent.parallelize(input_a=1)  # should parallelize when possible
    print(score2, explanation2)
